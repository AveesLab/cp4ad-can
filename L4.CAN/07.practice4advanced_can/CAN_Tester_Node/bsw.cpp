...
// print error code
void printErrorFlags(ErrorFlags _error) {
    ...
    for (int i = 15 ; i >= 0; i--) 
    {
        printfSerial("%d", (_error >> i) & 0x01); //print 1 bit
