# 1 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
# 27 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 28 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 29 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
# 1 "c:\\arduino\\hardware\\tools\\avr\\avr\\include\\avr\\interrupt.h" 1 3
# 30 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 31 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2
...
# 32 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2

# 1 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_private.h" 1
# 31 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\wiring_private.h"
...
# 34 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 2

static void nothing(void) {
}

static volatile voidFuncPtr intFunc[2] = {
# 62 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    nothing,
...
# 80 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    switch (interruptNum) {
# 172 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:

      
# 174 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)(0x69)) 
# 174 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           = (
# 174 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
              (*(volatile uint8_t *)(0x69)) 
# 174 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 175 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 175 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           |= (1 << 
# 175 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                    0
# 175 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
                        );
# 185 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 1:

      
# 189 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)(0x69)) 
# 189 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           = (
# 189 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
              (*(volatile uint8_t *)(0x69)) 
# 189 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 190 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 190 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           |= (1 << 
# 190 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                    1
# 190 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
                        );
# 200 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;

    case 2:
# 213 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
void detachInterrupt(uint8_t interruptNum) {
  if(interruptNum < 2) {
    ...
    switch (interruptNum) {
# 292 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    case 0:

      
# 294 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 294 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           &= ~(1 << 
# 294 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                     0
# 294 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
...
# 306 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
     (*(volatile uint8_t *)((0x1D) + 0x20)) 
# 306 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
           &= ~(1 << 
# 306 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
                     1
# 306 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
    ...
    case 2:
# 326 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
      break;
...
# 372 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"

# 372 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
void __vector_1 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_1 (void) 
# 372 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
{ intFunc[0](); }

# 373 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c" 3
void __vector_2 (void) __attribute__ ((signal,used, externally_visible)) ; void __vector_2 (void) 
# 373 "C:\\Arduino\\hardware\\arduino\\avr\\cores\\arduino\\WInterrupts.c"
{ intFunc[1](); }
