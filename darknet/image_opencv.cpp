...
//    IplImage *mat_to_ipl(cv::Mat mat);
    bool interest_class[80] = {false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, };
...
//		}
        ...
        //can_write
          if(strcmp("car", names[class_id])==0)
             car_cnt++;
          else if(strcmp("person", names[class_id])==0)
             person_cnt++;
		...
		unsigned short class_  = class_id;
